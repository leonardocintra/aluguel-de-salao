    ...
    <div className="bg-slate-900 py-12 text-white overflow-hidden relative">
      <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-slate-300 mb-6">
          Exemplo se cada aluguel ={" "}
          <span className="text-yellow-400 font-bold text-xl">R$ 650</span>
        </p>
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-400 mt-2">5 × R$ 650 =</p>
            <p className="text-4xl font-bold mt-2 text-red-500">
              -R$ 3.250<span className="text-sm">/mês</span>
            </p>
          </div>
        ...
        <p>
          <span className="text-slate-400">ROI de</span>{" "}
          <span className="text-green-400 font-bold text-3xl">+900%</span>{" "}
          <span className="text-slate-400">em reservas recuperadas</span>
        </p>
